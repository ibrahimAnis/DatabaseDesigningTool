...
{
context.clearRect(THIS.abscissa-5,THIS.ordinate-5,THIS.width+10,THIS.height+10);
...
{
var drawableTable=new DrawableTable(x,y,width,height);
var databaseTable=new DatabaseTable(getTitle(),drawableTable);
drawableTable.databaseTable=databaseTable;
...
if(tableName.val().length>0) selectedTableComponent.databaseTable.title=tableName.val();
...
selectedTableComponent.drawableTable.drawCircles();
});
...
title=getTitle();
//alert(title);
selectedTableComponent=createTable(relativeX,relativeY,DEFAULT_WIDTH,DEFAULT_HEIGHT,title);
selectedMenu="";
}
else
{
...
{
if(selectedTableComponent!=null) selectedTableComponent.draw();
 selectedTableComponent=tableComponents[index];
}
var obj=selectedTableComponent;
setTimeout(function()
{
obj.drawableTable.drawCircles();
},100);
